...
TEXTS: Dict[str, CodenamesTexts] = {
    "uk": CodenamesTexts(
        ...
        PROFILE_INVENTORY="🎒 <b>СПЕЦ-ІНВЕНТАР:</b>",
        PROFILE_INVENTORY_PCS="",
        PROFILE_CAPTAIN_BUFFS_BTN="👨‍✈️ Бафи капітана",
        ...
        GOTO_BOT_CARD_BTN="🤖 Перейти в бота",
        ...
        TURN_SWITCH_GIVER="Дає підказку: {name}!",
        ...
        BUFF_ARMOR_APPLIED="🛡 {name}",
        BUFF_INTERCEPT_APPLIED="⚡ {name}",
        BUFF_DETECTOR_RESULT="📡 виявив нейтральне слово: <b>{word}</b>",
        BUFF_REMAP_APPLIED="🗺 використав баф {buff} і змінив всі слова на полі",
        BUFF_REMAP_ERROR="Цей баф можна використати ТІЛЬКИ до відкриття першого слова!",
        BUFF_USED_INVENTORY="✅ <b>{name}</b> з команди {team} застосував {result} з інвентарю",
        BUFF_USED_DIAMONDS="✅ <b>{name}</b> з команди {team} купив і застосував {result} за {price} 💎",
        ...
        GAME_ENDED_TITLE="🏆 <b>ГРУ ЗАКІНЧЕНО!</b> {winner}",
        ...
        GAME_STARTED_MSG="🏁 <b>Гру розпочато!</b> {desc}",
        TIME_1M="1 хвилина",
        TIME_2M="2 хвилини",
        TIME_3M="3 хвилини",
        TIME_5M="5 хвилин",
        ...
        ADMIN_DEBUG_INFO="\n\n👨‍✈️ Command to enable captain auto-bot debug mode: <code>/debug_autobot</code>",
        ADMIN_LOG_SET_SUCCESS="✅ Логи перенаправлено сюди",
        ADMIN_UPDATED="Оновлено",
        SETTING_BUFFS="⚡ Бафи: {status}",
        ...
        HARDCORE_LIGHT_DESC="⏱ <b>Тік-Так</b> — кожен хід капітана бот додає нову чорну картку.",
        ...
        BUFF_BECOME_CAPTAIN_NAME="👨‍✈️ Стати капітаном",
        ...
        BUFF_BECOME_CAPTAIN_SHORT="👨‍✈️ Стати кап",
        BUFF_REVEAL_SHORT="🕵️ Розвідка",
        CAPTAIN_BUFFS_SECTION="👨‍✈️ <b>Капітанські бафи (активуються в інвентарі):</b>",
        BUY_AVOID_CAPTAIN_BTN="🚫 Купити Уникнути кап.",
        BUY_BECOME_CAPTAIN_BTN="👨‍✈️ Купити Стати кап.",
    ...
    "en": CodenamesTexts(
        ...
        PROFILE_CAPTAIN_BUFFS_BTN="👨‍✈️ Captain Buffs",
        ...
        BUFF_ARMOR_APPLIED="🛡 applied {name}",
        BUFF_INTERCEPT_APPLIED="⚡ applied {name}",
        BUFF_DETECTOR_RESULT="📡 detected a neutral word: <b>{word}</b>",
        BUFF_REMAP_APPLIED="🗺 used {buff} buff and changed all words on the board",
        BUFF_REMAP_ERROR="This buff can ONLY be used before the first word is revealed!",
        BUFF_USED_INVENTORY="✅ <b>{name}</b> from {team} Team used {result} from inventory",
        BUFF_USED_DIAMONDS="✅ <b>{name}</b> from {team} Team purchased and used {result} for {price} 💎",
        ...
        GAME_ENDED_TITLE="🏆 <b>GAME OVER!</b> {winner}",
        GAME_STATS="⏱ Duration: <b>{duration}</b>\n🔎 Words found: <b>{found}/{total}</b>",
        NEW_CLUE="🔎 New clue: <b>{clue}</b> ({count})",
        REVEAL_BUFF_NAME="🕵️‍♂️ Recon",
        REVEAL_BUFF_DESC="Reveal 1 word",
        ...
        GAME_STARTED_MSG="🏁 <b>Game started!</b> {desc}",
        TIME_1M="1 minute",
        TIME_2M="2 minutes",
        TIME_3M="3 minutes",
        TIME_5M="5 minutes",
        ...
        ADMIN_DEBUG_INFO="\n\n👨‍✈️ Команда для включення режиму налагодження авто-бота ведучого капітана: <code>/debug_autobot</code>",
        ADMIN_LOG_SET_SUCCESS="✅ Logs redirected here",
        ADMIN_UPDATED="Updated",
        SETTING_BUFFS="⚡ Buffs: {status}",
        ...
        BUFF_BECOME_CAPTAIN_NAME="👨‍✈️ Become Captain",
