...
TEXTS: Dict[str, CodenamesTexts] = {
    "uk": CodenamesTexts(
        ...
        TURN_SWITCH_TEAM="Хід переходить до: <b>{name}</b>!",
        ...
        BUFF_USED_INVENTORY="✅ <b>{name}</b> з {team} застосував/ла <b>{result}</b> з інвентарю",
        BUFF_USED_DIAMONDS="✅ <b>{name}</b> з {team} застосував/ла <b>{result}</b> за {price} 💎",
    ...
    "en": CodenamesTexts(
        ...
        BUFF_USED_INVENTORY="✅ <b>{name}</b> ({team}) ➡️ {result} (inventory)",
        BUFF_USED_DIAMONDS="✅ <b>{name}</b> ({team}) ➡️ {result} (-{price} 💎)",
