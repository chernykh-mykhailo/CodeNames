...
TEXTS: Dict[str, CodenamesTexts] = {
    "uk": CodenamesTexts(
        ...
        BUFF_USED_INVENTORY="✅ Команда {team} <b>{name}</b> використав {result} з інвентарю!",
        BUFF_USED_DIAMONDS="✅ Команда {team} <b>{name}</b> придбав {result} за {price} 💎!",
    ...
    "en": CodenamesTexts(
        ...
        BUFF_USED_INVENTORY="✅ {team} Team <b>{name}</b> used {result} from inventory!",
        BUFF_USED_DIAMONDS="✅ {team} Team <b>{name}</b> purchased {result} for {price} 💎!",
